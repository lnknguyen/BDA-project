...
plot_sale_price_cmd <- ggplot(data=numeric_train, aes(x = SalePrice))
plot_sale_price_cmd <- plot_sale_price_cmd + geom_histogram(fill="#134D8A", binwidth = 10000) + common_x_axis + decorated_x_axis_labels
...
plot_grid(
  g1, g2, g7, g8, g9, g10, g3,g4, g5, g6,  ncol=2
)
